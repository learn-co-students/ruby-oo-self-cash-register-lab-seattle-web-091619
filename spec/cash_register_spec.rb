describe 'CashRegister' do
  ...
  describe '#apply_discount' do
    context 'the cash register was initialized with an employee discount' do
      ...
      it 's success message with updated total' do
        cash_register_with_discount.add_item("macbook air", 1000)
    ...
    context 'the cash register was not initialized with an employee discount' do
      it 's a string error message that there is no discount to apply' do
  ...
  describe '#items' do
    it 'is an array containing all items that have been added' do
  ...
  describe '#void_last_transaction' do
    ...
    it 's the total to 0.0 if all items have been removed' do
